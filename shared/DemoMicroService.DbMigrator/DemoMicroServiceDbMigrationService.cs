...
public class DemoMicroServiceDbMigrationService : ITransientDependency
{
    private readonly ICurrentTenant _currentTenant;
    private readonly IDataSeeder _dataSeeder;
    private readonly ILogger<DemoMicroServiceDbMigrationService> _logger;
    private readonly ITenantRepository _tenantRepository;
    private readonly IUnitOfWorkManager _unitOfWorkManager;

    public DemoMicroServiceDbMigrationService(
        ILogger<DemoMicroServiceDbMigrationService> logger,
        ...
        CancellationToken cancellationToken)
    {
        using (var uow = _unitOfWorkManager.Begin(true))
        {
            ...
            await MigrateDatabaseAsync<ServiceOneDbContext>(cancellationToken);
            await MigrateDatabaseAsync<ServiceTwoDbContext>(cancellationToken);
